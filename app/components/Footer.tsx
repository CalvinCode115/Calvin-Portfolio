  ...
  return (
    <footer className="bg-surface border-t border-border py-10">
      ...
      <div className="mx-auto max-w-6xl px-6 flex flex-col items-center gap-5">
        ...
        <p className="text-sm text-zinc-500">© 2026 Calvin Lee. Built with Next.js.</p>
      </div>
    </footer>
  );
}
